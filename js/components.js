...
function uiIcon(name, extraClass = "") {
  const paths = {
    ...
    store: `<path d="M4 10h16"/><path d="M5 10l1-5h12l1 5"/><path d="M6 10v9h12v-9"/><path d="M9 19v-5h6v5"/>`,
    heart: `<path d="M12 20s-7-4.4-9-8.3C1.2 8.2 3.2 5 6.5 5c2 0 3.2 1.1 3.9 2.1C11.1 6.1 12.3 5 14.3 5c3.3 0 5.3 3.2 3.5 6.7C19 15.6 12 20 12 20Z"/>`,
